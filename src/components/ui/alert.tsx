  ...
  'relative w-full rounded-lg border border-zinc-200 p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-zinc-950 dark:border-zinc-800 dark:[&>svg]:text-zinc-50',
  {
    variants: {
      variant: {
        ...
        success:
          'border-emerald-500/50 text-emerald-500 dark:border-emerald-500 [&>svg]:text-emerald-500 dark:border-emerald-900/50 dark:text-emerald-900 dark:dark:border-emerald-900 dark:[&>svg]:text-emerald-900',
        destructive:
