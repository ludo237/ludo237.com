...
export default function CreateJobExperience() {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(route('job-experiences.store'));
    };
    ...
    return (
        <>
            <Head title="Add Job Experience" />

            <main className="mx-auto min-h-[100dvh] max-w-3xl px-6 py-12 md:px-0">
                <div className="space-y-6">
                    <header className="flex items-center justify-between">
                        <div>
                            <h1 className="text-4xl font-bold tracking-wide text-primary">Add Job Experience</h1>
                            <p className="mt-2 text-muted-foreground">Add a new role to your professional history</p>
                        </div>
